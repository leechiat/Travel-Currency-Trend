import { DestinationCurrency, HomeCurrency, MarketAsset } from '../types';
...
export const OTHER_MARKET_ASSETS: MarketAsset[] = [
  // Indices
  {
    id: 'sp500',
    symbol: 'S&P 500',
    ...
    low24h: 5940.20,
    volume: '2.84B',
    historicalPoints: [5890, 5910, 5905, 5930, 5960, 5950, 5982]
  },
  {
    id: 'nasdaq',
    symbol: 'NDX',
    ...
    low24h: 20900.50,
    volume: '3.92B',
    historicalPoints: [20700, 20850, 20920, 20900, 21050, 21100, 21140]
  },
  {
    id: 'nikkei',
    symbol: 'N225',
    ...
    low24h: 38800.00,
    volume: '1.45B',
    historicalPoints: [38200, 38500, 38400, 38900, 39100, 39350, 39420]
  },
  {
    id: 'dax',
    symbol: 'DAX',
    ...
    low24h: 19600.00,
    volume: '820M',
    historicalPoints: [19500, 19550, 19580, 19620, 19600, 19650, 19680]
  },
  // Stocks
  {
    id: 'aapl',
    ...
    volume: '48.2M',
    marketCap: '3.58T',
    historicalPoints: [228, 229, 231, 230, 233, 234, 234.5]
  },
  {
    id: 'nvda',
    symbol: 'NVDA',
    ...
    volume: '76.5M',
    marketCap: '3.49T',
    historicalPoints: [134, 136, 135, 139, 141, 140, 142.8]
  },
  {
    id: 'msft',
    symbol: 'MSFT',
    ...
    volume: '22.1M',
    marketCap: '3.18T',
    historicalPoints: [432, 431, 430, 429, 427, 429, 428.1]
  },
  // Crypto
  {
    id: 'btc',
    ...
    price: 94850.00,
    changePercent: 2.75,
    changeAmount: 2540.00,
    high24h: 95500.00,
    low24h: 92100.00,
    volume: '$42.8B',
    marketCap: '$1.87T',
    historicalPoints: [91000, 92200, 91800, 93400, 94100, 93900, 94850]
  },
  {
    id: 'eth',
    symbol: 'ETH/USD',
    ...
    volume: '$19.4B',
    marketCap: '$412B',
    historicalPoints: [3280, 3310, 3300, 3360, 3390, 3380, 3420.5]
  },
  {
    id: 'sol',
    symbol: 'SOL/USD',
    ...
    volume: '$6.2B',
    marketCap: '$91B',
    historicalPoints: [180, 182, 181, 187, 190, 189, 194.2]
  },
  // Forex
  {
    id: 'eurusd',
    ...
    low24h: 1.0830,
    volume: '$450B',
    historicalPoints: [1.089, 1.088, 1.087, 1.086, 1.085, 1.084, 1.0845]
  },
  {
    id: 'gbpusd',
    symbol: 'GBP/USD',
    ...
    low24h: 1.2925,
    volume: '$280B',
    historicalPoints: [1.291, 1.293, 1.292, 1.294, 1.295, 1.296, 1.2965]
  },
  {
    id: 'usdjpy',
    symbol: 'USD/JPY',
    ...
    low24h: 150.40,
    volume: '$390B',
    historicalPoints: [149.8, 150.1, 150.4, 150.8, 150.9, 151.1, 151.24]
  },
  // Futures
  {
    id: 'gold',
    ...
    low24h: 2724.00,
    volume: '240K',
    historicalPoints: [2710, 2725, 2720, 2735, 2740, 2738, 2748.6]
  },
  {
    id: 'oil',
    symbol: 'CL=F',
    ...
    low24h: 70.90,
    volume: '380K',
    historicalPoints: [73.2, 72.8, 72.5, 72.1, 71.8, 71.6, 71.45]
  },
  // Bonds
  {
    id: 'us10y',
    ...
    low24h: 4.40,
    volume: '$1.2T',
    historicalPoints: [4.49, 4.47, 4.46, 4.45, 4.44, 4.43, 4.42]
  },
  {
    id: 'bund10y',
    symbol: 'DE10Y',
    ...
    low24h: 2.31,
    volume: '$480B',
    historicalPoints: [2.30, 2.31, 2.32, 2.33, 2.33, 2.34, 2.34]
  }
];
